object VersionConstants {
    const val userdevVersion = "1.5.5"
    const val pluginYmlVersion = "0.5.3"
    const val shadowVersion = "8.1.1"
    const val minecraftVersion = "1.19.4-R0.1-SNAPSHOT"
    const val cloudVersion = "1.8.3"
    const val adventureVersion = "4.13.1"
    const val adventurePlatformVersion = "4.3.0"
