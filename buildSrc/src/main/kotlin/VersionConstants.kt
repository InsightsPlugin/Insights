object VersionConstants {
    const val userdevVersion = "1.3.5"
    const val pluginYmlVersion = "0.5.1"
    const val shadowVersion = "7.1.2"
    const val minecraftVersion = "1.18.2-R0.1-SNAPSHOT"
    const val cloudVersion = "1.6.2"
    const val adventureVersion = "4.10.0"
    const val adventurePlatformVersion = "4.1.0"
    ...
    const val commodoreVersion = "1.13"
